...
Далее подбор и заказ подшипников и 3D-печать уже из более прочного PET-G пластика и сборка. Кстати некоторые детали наружней оболочки кисти печатались из FLEX. Это даёт приятные тактильные ощущения.
...
<img src="/imgs/renders/into_head.jpeg" width="700"/>

Облако точек и цветное изображение роботу предоставляет 3D-камера Intel RealSense D455 со встроенным IMU. 
...
Аппаратное обеспечеине робота можно логически поделить на три блока:
1. Блок управления сервоприводами
2. Блок преобразования напряжения
3. Вычислительные модули

### Блок управления сервоприводами

За упраление системой сервоприводов рук и головы отвечают

### Блок преобразования напряжения

### Вычислительные модули + голова
