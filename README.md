...
В качестве основы для операционной системы робота было решено использовать ROS версии Noetic. Тогда архитектура системы будет выглядеть так:

<img src="/imgs/soft/OSsch.png" width="600"/>
