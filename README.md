...
Далее была собрана вся рука целиком и протестирована вместе с аппаратным обеспечение о котором расскажу в следующих разделах.
...
Для ускорения операций связанных с обработкой изображений дополнительно были закуплены процессоры машинного зрения (VPU) на базе архитектуры Intel Movidius Myriad X.
