...
После многих встреч, долгих разговоров и десятков эскизов было выработано видение дизайна робота, которое чуть позже было воплощено нашим дизайнером в дизайн-концепт.
...
Сейчас мы открываем для себя большое количество софта от Intel оптимизированного под их платформы аппаратные Intel NUC, Intel RealSence, Intel Movidius, наш робот, напиминаю, оснащён всеми этими устройствами. Заявленая эффективность такого решения впечатляет, сейчас разбираемся с их инфраструктурой.
