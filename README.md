...
Чтобы с чего-то начать пока робот ещё не собран, поставил пакет TurtleBot3 и, в симуляторе Gazebo, запустил модель робота Bruger, оснащённого лучевым 2D-лидаром.
