...
Для публикации в медиа съездили в DIY-магазни, закупили освещение и в помещении финансирующей компании отсняли небольшой проморолик по промежуточнуму результату.

[Youtube](https://www.youtube.com/watch?v=_gj3ynNgX4c)

<img src="/imgs/promo/promo3_480.gif" width="700"/>

Чтобы добиться от робота плавных движений использовал синусоидальные функции, эксперементируя с фазами.
