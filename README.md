...
Далее стояла задача смоделировать, из смоделированных дизайнером поверхностей оболочки, детали пригодные для вакуумной формовки. Тут уже работал я, совмещая поверхности с конструктивом, чтобы ещё и собрать это всё можно было

Далее стояла задача совместить смоделированные дизайнером поверхности оболочки с консруктивом, чтобы это ещё и собрать можно было.
