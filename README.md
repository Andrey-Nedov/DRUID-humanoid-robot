...
Замечание: изображение является проекцией трёхмерного облака точек чёрные области - это зоны недоступные для расчёта глубины ввиду или слишком маленького расстояния до камеры, или того что зона находится за другим объектом.
