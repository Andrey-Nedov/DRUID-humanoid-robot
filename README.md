...
Далее, после многих встреч, долгих разговоров и десятков эскизов было выработано видение дизайна робота, которое чуть позже было воплощено нашим дизайнером в дизайн-концепт.
...
Хорошо, вроде бы простейшая логика работы у нас уже есть, дальше я подключил Intel RealSense D455, интегрировал его в ROS и получил с него облако точек, так как 2D-лидара на нашем роботе нет.
